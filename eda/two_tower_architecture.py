...
class TwoTowerModel(nn.Module):
    def __init__(self, output_dim, embed_dim, lstm_hidden_dim_query, lstm_hidden_dim_doc, embeddings_tensor=None):
        """
        """
        super(TwoTowerModel, self).__init__()
        self.query_tower = DocTower(embed_dim, lstm_hidden_dim_query, output_dim, embeddings_tensor)
        self.doc_tower = DocTower(embed_dim, lstm_hidden_dim_doc, output_dim, embeddings_tensor)
